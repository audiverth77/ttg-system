                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <form id="createJobForm" class="mt-8" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="salary" id="salary" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                            </div>
